...
export default function Home() {
  ...
  async function fetchProducts() {
    const data = await fetch("https://next-mongo-zeta-one.vercel.app/product");
  ...
  const createProduct = (data) => {
    fetch("https://next-mongo-zeta-one.vercel.app/product", {
      method: "POST",
      headers: {
  ...
  const deleteById = (id) => async () => {
    ...
    await fetch(`https://next-mongo-zeta-one.vercel.app/product/${id}`, {
      method: "DELETE",
    });
    fetchProducts();
  }
